...
➡️ https://github.com/adamhlt/ImGui-Standalone

Modifications in this fork include:

- Updating **Dear ImGui** to the **latest Docking branch (v1.92.6)**.
- Updating project files and configuration to support the newer ImGui version.

Full credit for the original implementation goes to the original author.
